...
describe('utils/db', () => {
  ...
  // Test db.read success path - returns data array when Supabase select succeeds
  ...
  // Test db.read error handling - returns empty array and logs error when Supabase fails
  ...
  // Test db.insert success - returns {success: true, data} when Supabase insert succeeds
  ...
  // Test db.insert error handling - returns {success: false, error} 
