...
User Story Add Picture of Product
ในฐานะผู้ใช้งาน ฉันต้องการ add รูปสินค้า เพื่อที่ฉันจะสามารถเห็นลักษณะสินค้าก่อนตัดสินใจซื้อ
User Story Add Price of Product
ในฐานะผู้ใช้งาน ฉันต้องการ ราคาสินค้า เพื่อที่ฉันจะเห็นราคาสินค้าและใช้เปรียบเทียบก่อนตัดสินใจซื้อ
User Story Add Tags
ในฐานะผู้ใช้งาน ฉันต้องการ ราคาสินค้า เพื่อที่ฉันจะสามารถค้นหาและพบสินค้าที่เกี่ยวข้องได้ง่ายขึ้น
User Story Add link
ในฐานะผู้ใช้งาน ฉันต้องการเเอดลิงค์สินค้า เพื่อให้สามารถรู้ได้ว่าสินค้านี้มาจากเเอปอะไร
User Story Favorite
ในฐานะผู้ใช้งาน (User) ฉันต้องการเพิ่มรายการสินค้าที่สนใจ เพื่อให้สามารถกลับมาดูหรือซื้อในภายหลังได้
User Story category
ในฐานะผู้ใช้งาน ฉันต้องการดูสินค้าแยกตามหมวดหมู่ เพื่อให้ค้นหาสินค้าที่ต้องการได้ง่ายขึ้น
User Story Price Filter
ในฐานะผู้ใช้งาน ฉันต้องการเรียงลำดับราคาสินค้า เพื่อเปรียบเทียบราคาและตัดสินใจซื้อได้ง่าย
User Story Store Filter
ในฐานะผู้ใช้งาน ฉันต้องการกรองสินค้าตามแหล่งที่มา เช่น Shopee หรือ Lazada เพื่อดูเฉพาะร้านที่สนใจ
User Story Promotion
ในฐานะผู้ใช้งาน ฉันต้องการดูสินค้าที่มีโปรโมชั่น เพื่อให้ได้ลดราคาสินค้า
User Story Manage Category
ในฐานะผู้ดูแลระบบ (Admin) ฉันต้องการเพิ่ม แก้ไข และลบข้อมูลสินค้า เพื่อให้ข้อมูลในระบบถูกต้องและเป็นปัจจุบัน
User Story Manage Promotion
