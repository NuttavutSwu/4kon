...
**1.User Story Login**
<p>ในฐานะผู้ใช้งาน (User) ฉันต้องสามารถ login ด้วย gmail/username เเละ password เพื่อที่จะได้เข้าสู้ระบบได้</p>
**2️.User Story Register**
<p>ในฐานะผู้ใช้งาน ฉันต้องการสมัครสมาชิกด้วยอีเมล เพื่อให้สามารถเข้าใช้งานระบบได้</p>
**3️.User Story Logout**
<p>ในฐานะผู้ใช้งาน ฉันต้องการออกจากระบบ เพื่อป้องกันผู้อื่นเข้าถึงบัญชีของฉัน</p>
**4️.User Story Forgot Password**
<p>ในฐานะผู้ใช้งาน ฉันต้องการรีเซ็ตรหัสผ่านเมื่อจำไม่ได้ เพื่อกลับเข้าสู่ระบบได้อีกครั้ง</p>
**5.User Story Add Product description**
<p>ในฐานะผู้ใช้งาน ฉันต้องการเขียน description เพื่อที่ฉันจะสามารถย้อนกลับมาดูรายละเอียดสินค้า</p>
**6.User Story Add Picture of Product**
<p>ในฐานะผู้ใช้งาน ฉันต้องการ add รูปสินค้า เพื่อที่ฉันจะสามารถเห็นลักษณะสินค้าก่อนตัดสินใจซื้อ</p>
**7.User Story Add Price of Product**
<p>ในฐานะผู้ใช้งาน ฉันต้องการ ราคาสินค้า เพื่อที่ฉันจะเห็นราคาสินค้าและใช้เปรียบเทียบก่อนตัดสินใจซื้อ</p>
**8.User Story Add Tags**
<p>ในฐานะผู้ใช้งาน ฉันต้องการ ราคาสินค้า เพื่อที่ฉันจะสามารถค้นหาและพบสินค้าที่เกี่ยวข้องได้ง่ายขึ้น</p>
**9.User Story Add link**
<p>ในฐานะผู้ใช้งาน ฉันต้องการเเอดลิงค์สินค้า เพื่อให้สามารถรู้ได้ว่าสินค้านี้มาจากเเอปอะไร</p>
**10.User Story Favorite**
<p>ในฐานะผู้ใช้งาน (User) ฉันต้องการเพิ่มรายการสินค้าที่สนใจ เพื่อให้สามารถกลับมาดูหรือซื้อในภายหลังได้</p>
**11.User Story category**
<p>ในฐานะผู้ใช้งาน ฉันต้องการดูสินค้าแยกตามหมวดหมู่ เพื่อให้ค้นหาสินค้าที่ต้องการได้ง่ายขึ้น</p>
**12.User Story Price Filter**
<p>ในฐานะผู้ใช้งาน ฉันต้องการเรียงลำดับราคาสินค้า เพื่อเปรียบเทียบราคาและตัดสินใจซื้อได้ง่าย</p>
**13.User Story Store Filter**
<p>ในฐานะผู้ใช้งาน ฉันต้องการกรองสินค้าตามแหล่งที่มา เช่น Shopee หรือ Lazada เพื่อดูเฉพาะร้านที่สนใจ</p>
**14.User Story Promotion**
<p>ในฐานะผู้ใช้งาน ฉันต้องการดูสินค้าที่มีโปรโมชั่น เพื่อให้ได้ลดราคาสินค้า</p>
**15.User Story Manage Category**
<p>ในฐานะผู้ดูแลระบบ (Admin) ฉันต้องการเพิ่ม แก้ไข และลบข้อมูลสินค้า เพื่อให้ข้อมูลในระบบถูกต้องและเป็นปัจจุบัน</p>
**16.User Story Manage Promotion**
<p>ในฐานะผู้ดูแลระบบ ฉันต้องการจัดการข้อมูลโปรโมชั่น เพื่ออัปเดตโปรโมชันใหม่ได้</p>
**17.User Story Dashboard**
<p>ในฐานะผู้ดูแลระบบ ฉันต้องการดูประวัติการกดซื้อสินค้า เพื่อใช้วิเคราะห์พฤติกรรมผู้ใช้งาน</p>
